  ...
  return (
    <div className="col-span-3 space-y-2">
      ...
      <div className="space-y-5">
        <div>
          <Suspense fallback="—">
            <InsideDisbursements cycle={cycle} />
          </Suspense>
          <TextSection heading="Direct Campaign Spending">
            ...
            is the money behind the familiar &ldquo;I approve this
        ...
        <div>
          <Suspense fallback="—">
            <OutsideTotal cycle={cycle} />
          </Suspense>
          <TextSection heading="Independent Expenditures">
            ...
            spending is tightly regulated, independent expenditures allows
            massive amounts of money to shape elections from the outside.
          </TextSection>
        </div>
      </div>
    </div>
