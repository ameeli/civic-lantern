...
class TestCandidateIngestor:
    ...
    async def test_transform_delegates_to_transform_candidates(self, mock_transform, mock_client, mock_session):
    ...
    async def test_create_service_returns_candidate_service(self, mock_client, mock_session):
